...
<head>
  ...
  <title>EasyParki - Liste Des Reservations </title>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    <div class="container-fluid py-4">
      <div class="table-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
          <h2 class="mb-0">Liste Des Reservations</h2>
          <a href="AddReservation.php" class="btn btn-primary">
            <i class="fas fa-plus me-2"></i>Ajouter une Reservation
          </a>
        ...
        <table id="reservationsTable" class="table table-striped align-middle">
    <thead>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <i class="fas fa-parking" style="color:rgb(7, 3, 113); margin-right: 5px;"></i>
                <span style="font-weight: bold; color: #333;"><?= htmlspecialchars($reservation['Nom_Parking']) ?></span>
            </td>          
            <td><?= $reservation['idClient'] ?></td>
            <td>
                <i class="fas fa-user" style="color: rgb(7, 3, 113); margin-right: 5px;"></i>
                <span style="font-weight: bold; color: #333;"><?= htmlspecialchars($reservation['nom_client']) ?></span>
            </td>            
...
function exportToPDF() {
    ...
    setTimeout(() => {
        try {
            ...
            doc.text('Liste des Réservations - EasyParki', 14, 20);
            ...
            if (!table) {
                throw new Error("Le tableau avec l'ID 'reservationsTable' est introuvable.");
            }
            ...
            console.log(rows); // Vérifiez les données récupérées
            ...
            // Sauvegarde
            doc.save('reservations_easyparki_' + new Date().toISOString().slice(0, 10) + '.pdf');
...
document.getElementById('sortByNameBtn').addEventListener('click', () => {
    ...
    rows.sort((a, b) => {
        const nameA = a.cells[3].textContent.trim().toLowerCase(); // Column 3: Nom Client
...
document.getElementById('searchByIdBtn').addEventListener('click', () => {
    ...
    rows.forEach(row => {
        const idCell = row.cells[0].textContent.trim(); // Column 0: ID Réserv.
