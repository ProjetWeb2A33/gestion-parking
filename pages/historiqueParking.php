...
$c = new ParkingP();
$tab = $c->ListeParking();
$parkingsSupprimes = $c->getParkingsSupprimes();
    ...
    <div class="container-fluid py-4">
        <div class="table-container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">Historique des Parkings Supprimés</h2>
                <?php if (count($parkingsSupprimes) > 0): ?>
            ...
            <table id="parkingTable" class="table table-striped align-middle">
                ...
                <tbody>
                    <?php foreach ($parkingsSupprimes as $parking): ?>
                    <tr>
                        ...
                        <a href="javascript:void(0);" 
                            onclick="confirmRestaure(event, <?= $parking['ID_Parking'] ?>)" 
                            class="btn btn-sm btn-primary">
                            <i class="fas fa-edit"></i> Restaurer
                        </a>
                        <a href="DeleteDefinitive.php?ID_Parking=<?= $parking['ID_Parking'] ?>" 
            ...
            <?php if (count($parkingsSupprimes) === 0): ?>
                <p>Aucun parking supprimé trouvé.</p>
            <?php endif; ?>
        </div>
    </div>
    <?php endif; ?>
...
<script src="../assets/js/material-dashboard.min.js?v=3.2.0"></script>
  <script>
    ...
    function confirmRestaure(event, id) {
    ...
    modal.innerHTML = `
        <div class="modal-content">
            <h4>Confirmer la restauration</h4>
            <p>Êtes-vous sûr de vouloir restaurer ce parking ?</p>
            <form method="POST" action="restaurerParking.php">
                <input type="hidden" name="ID_Parking" value="${id}">
    ...
    modal.innerHTML = `
        ...
        ">
            ...
            ">
                ...
                <p>Êtes-vous sûr de vouloir supprimer définitivement ce parking ?</p>
                <div style="display: flex; justify-content: center; gap: 15px; margin-top: 20px;">
                    ...
                    <a href="DeleteDefinitive.php?ID_Parking=${id}" 
...
function exportToPDF() {
    ...
    setTimeout(() => {
        try {
            ...
            doc.text('Historiques des Parkings - EasyParki', 14, 20);
