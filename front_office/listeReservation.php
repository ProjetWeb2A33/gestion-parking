      ...
      <form class="row g-2 align-items-center">
        ...
        <div class="search-container text-center my-4">
          <div class="input-group" style="max-width: 400px; margin: 0 auto;">
              <input type="text" id="searchByIdInput" class="form-control" placeholder="Rechercher par ID de réservation">
...
document.getElementById('searchByIdBtn').addEventListener('click', () => {
    ...
    rows.forEach(row => {
        const idCell = row.cells[0].textContent.trim(); // Colonne 0 : ID Réservation
